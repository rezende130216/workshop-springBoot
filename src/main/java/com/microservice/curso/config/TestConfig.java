package com.microservice.curso.config;

import com.microservice.curso.entities.*;
import com.microservice.curso.entities.enums.OrderStatus;
import com.microservice.curso.repository.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Payment pay1 = new Payment(null, Instant.parse("2019-07-22T18:21:22Z"), o1 );
        o1.setPayment(pay1);
